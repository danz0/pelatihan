...
Produk yang bersifat proprietary memiliki banyak restriksi terutama dari sisi kode sumber dan desain.
...
\itab{- Penggunaan software bajakan bisa menghemat uang untuk jangka pendek, namun dari segi keamanan }\\
\itab{\hspace{6pt}PC tidak terjamin.}\\
\itab{- Software bajakan tempat bersarangnya malware, yaitu aplikasi computer yang khusus dibuat dengan tujuan }\\
\itab{\hspace{6pt}mencari kelemahan software.}\\
